...
void ColourTriangle::initBuffers(ID3D11Device* device)
{
	...
	vertices[0].position = XMFLOAT3(-3.85f, 2.06f, 0.0f);  // top left.
	vertices[0].texture = XMFLOAT2(0.0f, 1.0f);

	vertices[1].position = XMFLOAT3(-3.85f, -2.06f, 0.0f);  // bottom left.
	vertices[1].texture = XMFLOAT2(0.0f, 0.0f);

	vertices[2].position = XMFLOAT3(3.85f, -2.06f, 0.0f);  // bottom right.
	vertices[2].texture = XMFLOAT2(1.0f, 0.0f);

	vertices[3].position = XMFLOAT3(3.85f, 2.06f, 0.0f);  // top right.
